...
a / b+ plot_layout(guides = 'collect', heights = c(6, 1))
...
(b4/a3) + plot_annotation("origin = 0, rm.outliers = F, custom horizonscale")+ plot_layout(guides = 'collect', heights = c(6, 1))
...
cutpoints_a4  <- cutpoints_a4 %>% arrange(desc(cuts))


b4 <- plotAllLayers(dat_tab, -298.55, cutpoints_a4$cuts, cutpoints_a4$color)

(b4/a4) + plot_layout(guides = 'collect', heights = c(6, 1))
