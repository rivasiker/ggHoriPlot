...
You can install `ggHoriPlot` from CRAN using `install.packages("ggHoriPlot")`. You can also install the development version of the package with the following command:
