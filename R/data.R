...
#'
#' A dataset containing the geographic distribution of
#' COVID-19 cases in Asia during 2020.
#'
...
#'
#' A dataset containing the percentage of simple repeats
#' in 100 kb windows along the human genome (hg38).
#'
...
#'
#' A dataset containing the average temperature in Fahrenheit
#' for major cities in the US for the year 2000.
#'
...
#'
#' A dataset containing the average temperature in degrees Celsius
#' for Copenhagen between the year 1995 and 2019.
#'
